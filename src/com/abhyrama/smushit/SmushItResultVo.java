...
public class SmushItResultVo {
  ...
  public static SmushItResultVo create(Map map) {
    ...
    System.out.println(smushedImageUrl);
    ...
    if(smushItResultVo.getSmushedImageSize().equalsIgnoreCase("-1")) {
        smushItResultVo.setSmushedImageSize(smushItResultVo.getSourceImageSize());
    }
    smushItResultVo.setSavingPercentage((String.valueOf(map.get(JSON_RESPONSE_PARAM_PERCENT))));
    if("null".equals(smushItResultVo.getSavingPercentage())) {
        smushItResultVo.setSavingPercentage(
                String.valueOf(100 - (Double.valueOf(smushItResultVo.getSmushedImageSize())/
                Double.valueOf(smushItResultVo.getSourceImageSize()))*100)
        );
    }
